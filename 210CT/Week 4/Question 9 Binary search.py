def Bsearch (slist, low, high):                                                                       
    ...
    listLast = len(slist)-1 #this gets the length of the string and -1, this is the last value          
    
    while listFirst < listLast:                                                                              
        mid = (listFirst + listLast)//2 # selects mididle value as a starting value                             
        if slist[mid] in range (low, high): # checks if the middle value is in range                                     
            ...
            if slist[mid] > low:                                                 
                ...
                listFirst = mid +1
    return False                                                                                
Bsearch([5,6,7,8,11,15,20,22,23,24,25,27,28,29],25,28)
